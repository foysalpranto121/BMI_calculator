...
import '../Components/ract_button.dart';
      ...
      body: Padding(
        ...
        child: SafeArea(
          child: Column(
            children: [
              const Row(
                children: [Icon(Icons.arrow_back_ios_new, size: 20), Text("Back")],
              ),
                ...
                child: Expanded(
                  child: Obx(
                    () => CircularPercentIndicator(
                      ...
                      backgroundColor: bmiConroller.colorStattus.value.withOpacity(0.2),
                    ),
                  ),
                ),
              ),
